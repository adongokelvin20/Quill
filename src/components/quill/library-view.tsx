            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="relative aspect-[3/4] overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 p-4 text-left"
                >
                  <div className="flex h-full flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      {book.subtitle && (
                        <div className="mt-1 text-xs text-yellow-200/80">{book.subtitle}</div>
                      )}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-blue-600/90 opacity-0 transition-opacity group-hover:opacity-100">
                    <span className="inline-flex items-center gap-2 rounded-lg bg-yellow-500 px-4 py-2 text-sm font-medium text-blue-950 shadow-lg">
